...
public class AutoUpdateService extends Service {
    ...
    private static int mHour = 1000 * 60 * 60;
    public static int updateCount = 2;
    private static int updateTime = mHour * updateCount;
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Toast.makeText(getApplicationContext(),"获取数据成功,刷新频率:"+updateCount+"小时/次",Toast.LENGTH_SHORT).show();
